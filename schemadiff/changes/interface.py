...
class InterfaceFieldAdded(Change):
    ...
    def __init__(self, interface, field_name, field) -> None:
...
class InterfaceFieldRemoved(Change):
    ...
    def __init__(self, interface, field_name) -> None:
        self.interface = interface
        self.field_name = field_name
...
class AbstractInterfaceChange(Change):
    def __init__(self, interface, field_name, old_field, new_field) -> None:
        self.interface = interface
        self.field_name = field_name
...
class NewInterfaceImplemented(Change):
    ...
    def __init__(self, interface, type_) -> None:
        self.interface = interface
        self.type_ = type_
...
class InterfaceFieldDeprecationReasonChanged(AbstractInterfaceChange):
    criticality = Criticality.breaking(
        "Breaking change"
    )  # TODO: Improve this logic to check if it was deprecated before
