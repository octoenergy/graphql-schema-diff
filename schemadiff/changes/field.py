...
class FieldDescriptionChanged(Change):
    ...
    def __init__(self, new_type, name, old_field, new_field) -> None:
        self.type = new_type
...
class FieldDeprecationReasonChanged(Change):
    ...
    def __init__(self, type_, name, old_field, new_field) -> None:
        self.type_ = type_
        self.field_name = name
        self.old_field = old_field
        self.new_field = new_field
...
class FieldTypeChanged(Change):
    def __init__(self, type_, field_name, old_field, new_field) -> None:
        self.criticality = (
            Criticality.safe()
...
class FieldArgumentAdded(Change):
    def __init__(
        self, parent, field_name: str, field: GraphQLField, argument_name, arg_type
    ) -> None:
        self.criticality = (
            Criticality.safe("Adding an optional argument is a safe change")
...
class FieldArgumentRemoved(Change):
    ...
    def __init__(self, parent, field_name, argument_name) -> None:
        self.parent = parent
        self.field_name = field_name
        self.argument_name = argument_name
